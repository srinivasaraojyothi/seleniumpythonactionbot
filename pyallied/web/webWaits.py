...
class customwebDriverwait:
    ...
    def WaitFor_VisibilityOf_Element_Located(self, xpath):
        try:
            ...
            return WebDriverWait(self.driver, self.customWait).until(
    ...
    def WaitFor_element_attribute_to_include(self, xpath, value):
        try:
            return WebDriverWait(self.driver, self.customWait).until(
                EC.element_attribute_to_include((By.XPATH, xpath), value))
        except Exception as error:
            raise error
    ...
    def WaitFor_element_located_selection_state_to_be(self, xpath, is_Selected):
        try:
            return WebDriverWait(self.driver, self.customWait).until(
                EC.element_located_selection_state_to_be((By.XPATH, xpath), is_Selected))
        except Exception as error:
            raise error
    ...
    def WaitFor_element_selection_state_to_be(self, xpath, is_Selected):
        try:
            return WebDriverWait(self.driver, self.customWait).until(
                EC.element_selection_state_to_be((By.XPATH, xpath), is_Selected))
        except Exception as error:
            raise error
    ...
    def WaitFor_text_to_be_present_in_element(self, xpath, text_):
        try:
            return WebDriverWait(self.driver, self.customWait).until(
                EC.text_to_be_present_in_element((By.XPATH, xpath), text_))
        except Exception as error:
            raise error
    ...
    def WaitFor_text_to_be_present_in_element_attribute(self, xpath, attribute, text_):
        try:
            return WebDriverWait(self.driver, self.customWait).until(
                EC.text_to_be_present_in_element_attribute((By.XPATH, xpath), attribute, text_))
        except Exception as error:
            raise error
    ...
    def WaitFor_text_to_be_present_in_element_value(self, xpath, text_):
        try:
            return WebDriverWait(self.driver, self.customWait).until(
                EC.text_to_be_present_in_element_value((By.XPATH, xpath), text_))
        except Exception as error:
            raise error
    ...
    def WaitFor_Visibility_of_Element_Located_AnyLocatorType(self, locatorType: str, locator):
        ...
        try:
            if (locatorType.upper() == 'XPATH'):
                ...
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.visibility_of_element_located((By.PARTIAL_LINK_TEXT, locator)))
            elif (locatorType.upper() == 'TAG_NAME'):
                return WebDriverWait(self.driver, self.customWait).until(
    ...
    def WaitFor_invisibility_of_Element_Located_AnyLocatorType(self, locatorType: str, locator):
        ...
        try:
            if (locatorType.upper() == 'XPATH'):
                ...
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.invisibility_of_element_located((By.ID, locator)))
            elif (locatorType.upper() == 'CLASS_NAME'):
                return WebDriverWait(self.driver, self.customWait).until(
                ...
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.invisibility_of_element_located((By.LINK_TEXT, locator)))
            elif (locatorType.upper() == 'NAME'):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.invisibility_of_element_located((By.NAME, locator)))
            elif (locatorType.upper() == 'PARTIAL_LINK_TEXT'):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.invisibility_of_element_located((By.PARTIAL_LINK_TEXT, locator)))
            elif (locatorType.upper() == 'TAG_NAME'):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.invisibility_of_element_located((By.TAG_NAME, locator)))
            else:
                raise Exception(" ** wrong selector/ no selector ** ", locatorType.upper())
        except Exception as error:
            raise error
    ...
    def WaitFor_frame_to_be_available_and_switch_to_it_AnyLocator(self, locatorType: str, locator):
        ...
        try:
            if (locatorType.upper() == "XPATH"):
                ...
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.frame_to_be_available_and_switch_to_it((By.CLASS_NAME, locator)))
            elif (locatorType.upper() == "CSS_SELECTOR"):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.frame_to_be_available_and_switch_to_it((By.CSS_SELECTOR, locator)))
            elif (locatorType.upper() == "LINK_TEXT"):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.frame_to_be_available_and_switch_to_it((By.LINK_TEXT, locator)))
            elif (locatorType.upper() == "NAME"):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.frame_to_be_available_and_switch_to_it((By.NAME, locator)))
            elif (locatorType.upper() == "PARTIAL_LINK_TEXT"):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.frame_to_be_available_and_switch_to_it((By.PARTIAL_LINK_TEXT, locator)))
            elif (locatorType.upper() == "TAG_NAME"):
                return WebDriverWait(self.driver, self.customWait).until(
                    EC.frame_to_be_available_and_switch_to_it((By.TAG_NAME, locator)))
            else:
                raise Exception(" ** wrong selector/ no selector ** ", locatorType.upper())
        except Exception as error:
            raise error
